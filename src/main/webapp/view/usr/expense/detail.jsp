...
<div class="container mt-4">
			...
			<td>
				<div class="category-wrap">
					<c:if test="${not empty expense.mainCategoryName}">
						<span class="category-main"> ${expense.mainCategoryName} </span>
					</c:if>

					<c:if test="${not empty expense.subCategoryName}">
						<span class="category-sub"> ${expense.subCategoryName} </span>
					</c:if>
				</div>
			</td>
		</tr>
	...
	<div class="mt-3">
		...
		<a href="/usr/expense/list" class="btn btn-secondary btn-sm"> <i
			class="bi bi-list-ul"></i> 목록
		</a> <a href="/usr/expense/modify?id=${expense.id}"
