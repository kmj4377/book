...
<div class="px-6 pt-4 max-w-3xl mx-auto">
	...
	<c:if test="${!isInclude}">
		<form id="searchForm" method="get" class="mb-4 flex gap-2">
			...
			</select> <select name="month" id="month" class="border p-1 rounded">
			...
			<button type="submit"
				class="bg-blue-500 text-white px-3 py-1 rounded">조회</button>
		</form>
	</c:if>
	...
	<div class="mt-6 p-4 bg-white rounded shadow text-center">
		<div class="text-lg font-semibold">
			예산: <span id="budgetAmount"></span> 원
		</div>
		<div class="text-lg font-semibold">
			지출: <span id="totalExpense"></span> 원
		</div>
		<div class="text-lg font-semibold text-blue-600">
			달성률: <span id="percent"></span>%
		</div>
	</div>
</div>
