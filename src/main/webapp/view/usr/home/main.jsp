        ...
        <div class="text-3xl font-bold">
            <c:if test="${not empty sessionScope.loginedMember}">
                ...
                <span class="text-blue-500">
                    ${sessionScope.loginedMember.nickname}
                </span> 님!
            </c:if>
        </div>

        <form method="get" action="/usr/expense/list" class="flex items-center gap-3">
    ...
    <div class="card-row">
        ...
        <div class="card-box bg-pink-100 text-center">
            ...
            <div class="text-4xl font-extrabold text-pink-600">
                <fmt:formatNumber value="${monthlyExpense}" />원
            </div>
        </div>
        ...
        <div class="card-box bg-blue-100 text-center">
            ...
            <div class="text-4xl font-extrabold text-blue-600">
                <fmt:formatNumber value="${budget != null ? budget.amount : 0}" />원
            </div>
        </div>
        ...
        <div class="card-box bg-green-100 text-center">
            ...
            <div class="text-4xl font-extrabold text-green-600">
                <fmt:formatNumber value="${saving}" />원
            </div>
        </div>
    </div>
        ...
        <div class="panel small-panel">
            ...
            <p>이번달 총 지출:
                <strong class="text-blue-600">
                    <fmt:formatNumber value="${thisMonthTotal}" />원
                </strong>
            </p>

            <p>지난달 총 지출:
                <strong>
                    <fmt:formatNumber value="${lastMonthTotal}" />원
                </strong>
            </p>
            ...
            <div class="text-center mt-3">
                <a href="/usr/expensestat/compare" class="btn btn-primary">
                    지출 추세 보기 →
                </a>
            </div>
        </div>
        ...
        <div class="panel small-panel">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <p class="mb-2">
                        오늘은
                        <strong>${fn:length(todayExpenseList)}건</strong>,
                        <strong>
                            <fmt:formatNumber value="${todayCount}" />원
                        </strong>
                        사용했어요
                    ...
                    <ul class="text-sm text-gray-700">
                        <c:forEach var="e" items="${todayExpenseList}" begin="0" end="2">
						    <li>
						        ...
						        :
						        <fmt:formatNumber value="${e.amount}" />원
						    </li>
						</c:forEach>
                        ...
                        <c:if test="${fn:length(todayExpenseList) > 3}">
                            <li class="text-gray-400">
                                … 외 ${fn:length(todayExpenseList) - 3}건
                            </li>
                        </c:if>
                    </ul>
                </c:otherwise>
